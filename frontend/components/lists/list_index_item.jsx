  ...
  handleNewCard(e) {
    ...
    this.props
      ...
      .then(e => {
        this.setState(
          ...
          e => {
            ...
            document
              .getElementById(`card-f-${this.state.id}`)
      ...
      .fail(e => {
        ...
        document
          .getElementById(`card-text-${this.state.id}`)
    ...
    return (
      <div className="board-list-container">
        <div className="list-content-container">
          <div
            onMouseEnter={() =>
              $(`#delete-${this.state.id}`).removeClass("hidden2")
            }
            onMouseLeave={() =>
              $(`#delete-${this.state.id}`).addClass("hidden2")
            }
            className="board-list-title"
          >
            <div
              id={`list-title-text-${list.id}`}
              className="list-title-text board-name"
            >
              <div onClick={this.focusInput}>{this.state.title}</div>
              <i
                id={`delete-${this.state.id}`}
                onClick={this.handleDelete}
                className="far fa-trash-alt btn hidden2"
              ></i>
            </div>
          ...
          <div className="list-cards-container">
            ...
            <div className="c-form-container">
              ...
              >
                ...
                <div
                  id={`card-actions-container-${this.state.id}`}
