      ...
      <div className="splash-row">
        <div className="splash-column sm-col">
          ...
          <p>
            ...
            vacation, Trallo helps your team stay organized.
          </p>
          <p>
        ...
        <div className="splash-column">
          <div className="board-img">
            <img
              src="https://trello-attachments.s3.amazonaws.com/5b9270821913198b25dc6c3f/5dc991d0b414ca552bc7aa95/5f8b2c5f8b21276bd6a816acf486faa1/board.png"
              alt="board"
            />
          </div>
        </div>
