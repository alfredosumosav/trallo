            ...
            <div className="splash-col">
                ...
                <div className="splash-row">
                    <div className="splash-col splash-card">
                        <div className="img">
                            <img src="https://d2k1ftgv7pobq7.cloudfront.net/meta/p/res/images/0cad30a99820b0d840a5b48635d00b6e/updated-layouts-collab.png" width="270" alt=""></img>
                        </div>
                    ...
                    <div className="splash-col splash-card">
                        <div className="img">
                            <img src="https://d2k1ftgv7pobq7.cloudfront.net/meta/p/res/images/15e77c8347135120a438d17e38195e44/updated-layouts-platform.png" width="270" alt=""></img>
                        </div>
                    ...
                    <div className="splash-col splash-card">
                        <div className="img">
                            <img src="https://d2k1ftgv7pobq7.cloudfront.net/meta/p/res/images/6eaaf5e37ab67a8ed6cd7764660513b9/updated-layouts-sync.png" width="270" alt=""></img>
                        </div>
