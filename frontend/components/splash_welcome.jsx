...
const SplashWelcome = (props) => {
    return (
        <div className="splash-container welcome-container">
            <div className="welcome-msg">
                <h1>Trallo lets you work more collaboratively and get more done.</h1>
                <p>Trallo’s boards, lists, and cards enable you to organize and prioritize your projects in a fun, flexible, and rewarding way.</p>
            </div>
